 ...
 */
final class Version20200925134548 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE person (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, first_name VARCHAR(20) NOT NULL, last_name VARCHAR(25) NOT NULL, street_name VARCHAR(50) NOT NULL, street_number VARCHAR(10) NOT NULL, zipcode VARCHAR(10) NOT NULL, age INT NOT NULL, gender VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_34DCD176A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
